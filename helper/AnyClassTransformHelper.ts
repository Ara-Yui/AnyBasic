...
export class AnyClassTransformHelper {
   ...
   * ```
   */
  static toAliasJson<T extends AnyBaseModel>(
    instance: T,
    toAliasType?: EToAliasType
  ): TBaseType {
   ...
   * ```
   */
  static toInstance<T extends AnyBaseModel>(
    data: TBaseType = {},
    classz: ClassConstructor<T>
  ): T {
   ...
   * ```
   */
  static toInstanceArray<T extends AnyBaseModel>(
    data: TBaseType[] = [],
    classz: ClassConstructor<T>
  ): T[] {
